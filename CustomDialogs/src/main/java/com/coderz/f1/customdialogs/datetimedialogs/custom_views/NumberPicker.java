...
package com.coderz.f1.customdialogs.datetimedialogs.custom_views;
...
public class NumberPicker extends LinearLayout {
    ...
    public int getSelectionBarTextColor() {
...
//    private final ImageButton mDecrementButton;
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        mSelectionTextColor = ResourcesCompat.getColor(context.getResources(),R.color.black,context.getTheme());
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < selectorIndices.length; i++) {
            int oldColor = mSelectorWheelPaint.getColor();
            if (i== SELECTOR_MIDDLE_ITEM_INDEX){
                mSelectorWheelPaint.setColor(mSelectionTextColor);
            } else {
                //NOTE: add field for NonSelectedIndices text color
                //NOTE: add field for NumberPicker Background Color
            ...
            mSelectorWheelPaint.getTextBounds(scrollSelectorValue,0,scrollSelectorValue.length(),tBounds);
            float offSet = tBounds.height()/2;
            canvas.drawText(scrollSelectorValue, x, y + offSet , mSelectorWheelPaint);
            y += mSelectorElementHeight;
            mSelectorWheelPaint.setColor(oldColor);
        }
    }
